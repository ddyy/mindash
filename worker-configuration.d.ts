/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f5f68633d7340ea3d5f7d14584a117fa)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUSH_TOKEN_BACKUP_DEMO">> {}
}
declare module "*.yaml" {
	const value: string;
